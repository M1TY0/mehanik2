namespace Mehanik.Main_Menu
{
    partial class DeleteForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            button1.Location = new Point(47, 90);
            button1.Name = "button1";
            button1.Size = new Size(308, 224);
            button1.TabIndex = 0;
            button1.Text = "Изтриване на клиент";
            ...
            button2.Location = new Point(189, 436);
            button2.Name = "button2";
            button2.Size = new Size(308, 224);
            button2.TabIndex = 1;
            button2.Text = "Изтриване на механик";
            ...
            button3.Location = new Point(674, 436);
            button3.Name = "button3";
            button3.Size = new Size(308, 224);
            button3.TabIndex = 2;
            button3.Text = "Изтриване на услуга";
            ...
            button4.Location = new Point(462, 90);
            button4.Name = "button4";
            button4.Size = new Size(308, 224);
            button4.TabIndex = 3;
            button4.Text = "Изтриване на част";
            ...
            button5.Location = new Point(861, 90);
            button5.Name = "button5";
            button5.Size = new Size(308, 224);
            button5.TabIndex = 4;
            button5.Text = "Изтриване на работа";
